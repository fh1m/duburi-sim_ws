...
> [`duburi_ws/sim/`](https://github.com/fh1m/duburi_ws/tree/main/sim), which is canonical. This copy is
> regenerated by `tools/sync_sim_mirror.sh` for sim-only work. **Open pull
> requests against [https://github.com/fh1m/duburi_ws](https://github.com/fh1m/duburi_ws)** — changes committed here are
...
The MAVLink and camera surface the autonomy stack in [`../src`](https://github.com/fh1m/duburi_ws/blob/main/src) expects,
without a pool.
...
[`../src/duburi_manager/test/test_sim_contract_drift.py`](https://github.com/fh1m/duburi_ws/blob/main/src/duburi_manager/test/test_sim_contract_drift.py),
...
| **Terminal-by-terminal cold start** | [`../README.md`](https://github.com/fh1m/duburi_ws/blob/main/README.md#-simulator--gazebo--ardusub-sitl) |
